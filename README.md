...
En este lugar vamos matener un repositorio con material que resulte de utilidad para realizar los trabajos prácticos de la materia. Recuerden que además existe una [página web](http://materias.df.uba.ar/scytda2020c1/), donde pueden encontrar cronogramas, las clases teoricas, guías y otro tipo de material adicional.
(creditos: la implementacion original de este repo data de la cursada 2018 y fue llevada adelante por los grossos de Gonza Uribarri y Agustin Somacal)
...
### Sobre Python y R
Durante la cursada, será necesario adquirir conocimientos básicos de **Python** o **R** para poder realizar los trabajos prácticos.  Sabemos que el bagaje de conocimientos en programación dentro del curso es diverso, pero estamos convencidos que todos podrán realizar las prácticas requeridas si le dedican el tiempo suficiente. Les dejamos algunas sugerencias de tutoriales sobre **R** y **Python** (haciendo notar que este ultimo es el lenguaje que ambos ayudantes manejan mejor, y por ende en el que mas los pueden ayudar) para que puedan ir calentando los motores si se sienten fuera de práctica:

* [R intro basica y redes] (https://kateto.net/networks-r-igraph) : Gran tutorial que , empezando muy basico da un paseo por la funcionalidad de igraph, un potente paquete para analizar redes complejas.
